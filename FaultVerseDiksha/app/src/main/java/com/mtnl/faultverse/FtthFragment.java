...
import com.mtnl.faultverse.databinding.FragmentFtthBinding;
...
public class FtthFragment extends Fragment {
    FragmentFtthBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ExpandableAdminClass [] expandableAdminClass = new ExpandableAdminClass[10];//Size

        try {
            binding = FragmentFtthBinding.inflate(inflater,container,false);
            ...
            ResultSet resultSet1 = statement.executeQuery("select count(*) from FtthComplaintsPendingView");
            int count = 0;
            if (resultSet1.next()) {
...
//            ResultSet resultSet2 = statement.executeQuery("select COMPLAINT_NO,BOOKING_DATETIME,SERVICE_NUMBER,ISSUE,ISSUE_DESCRIPTION,PHONE_NO,DP,RE,ADSL_IN,ADSL_OUT,STATUS,FNAME,LNAME,STREETADDRESS,DISTRICT,PINCODE from LandlineComplaintsPendingView");
            ResultSet resultSet2 = statement.executeQuery("select * from FtthComplaintsPendingView");
            int a=0;
            ...
            binding.ftthComplaint.setAdapter(adapter);
            resultSet2.close();
            connection.close();
            statement.close();
        }
        ...
        binding.compliButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    ResultSet resultSet1 = statement.executeQuery("select count(*) from FtthComplaintsClearedView ");
                    int count = 0;
                    if (resultSet1.next()) {
                        count += resultSet1.getInt(1);
                    }
...
//            ResultSet resultSet2 = statement.executeQuery("select COMPLAINT_NO,BOOKING_DATETIME,SERVICE_NUMBER,ISSUE,ISSUE_DESCRIPTION,PHONE_NO,DP,RE,ADSL_IN,ADSL_OUT,STATUS,FNAME,LNAME,STREETADDRESS,DISTRICT,PINCODE from LandlineComplaintsClearedView ");
                    ResultSet resultSet2 = statement.executeQuery("select * from FtthComplaintsClearedView ");
                    int a=0;
                    String compId, bookdt, serv_no, comp_Issue, comp_Issue_Des, phone, dp, re, adslin, adslout, status, sa, dis, pincode, fname, lname, name, address;
                    while (resultSet2.next()){
                        compId = resultSet2.getString("COMPLAINT_NO");
        ...
        binding.inProgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    ResultSet resultSet1 = statement.executeQuery("select count(*) from FtthComplaintInprogress ");
                    int count = 0;
                    if (resultSet1.next()) {
                        count += resultSet1.getInt(1);
                    }
...
//            ResultSet resultSet2 = statement.executeQuery("select COMPLAINT_NO,BOOKING_DATETIME,SERVICE_NUMBER,ISSUE,ISSUE_DESCRIPTION,PHONE_NO,DP,RE,ADSL_IN,ADSL_OUT,STATUS,FNAME,LNAME,STREETADDRESS,DISTRICT,PINCODE from LandlineComplaintsPendingView");
                    ResultSet resultSet2 = statement.executeQuery("select * from FtthComplaintInprogress ");
                    int a=0;
                    String compId, bookdt, serv_no, comp_Issue, comp_Issue_Des, phone, dp, re, adslin, adslout, status, sa, dis, pincode, fname, lname, name, address;
                    while (resultSet2.next()){
                        compId = resultSet2.getString("COMPLAINT_NO");
